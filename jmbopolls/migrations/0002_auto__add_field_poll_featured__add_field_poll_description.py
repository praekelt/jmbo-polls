...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.featured'
        db.add_column('poll_poll', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Poll.description'
        db.add_column('poll_poll', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Poll.featured'
        db.delete_column('poll_poll', 'featured')

        # Deleting field 'Poll.description'
        db.delete_column('poll_poll', 'description')
