...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.publish_on'
        db.alter_column('poll_poll', 'publish_on', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Poll.publish_on'
        db.alter_column('poll_poll', 'publish_on', self.gf('django.db.models.fields.DateTimeField')())
